...
class Ejemplos extends Element{
 ...
 function construct($id = null, &$specialDataStorage = null) {
    ...
    $this->inicioSem = new Datas\TimeSince('Inicio de Semestre', null, 'hours', 'ymd');
    $this->finSem = new Datas\TimeTo('Fin de Semestre', null, 'hourss', 'ymd');
    ...
    $this->include = new Datas\HTMLInclude('Encabezado',array('Encabezado.html','Cuerpo.html','Pie.html'),'C');
