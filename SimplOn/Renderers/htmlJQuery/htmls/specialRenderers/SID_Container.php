...
function SR_special_Fill(SD_Data $Data, phpQueryObject $template){
...
function SR_special_Get($Data, $method){
    ...
    foreach($Data->sources() as $source){
        ...
        $sourceDom[".$method>*:first-child>*:first-child"]->addClass(' item '.$source->name());
        $ret.=$sourceDom[".$method>*:first-child"]->html();
    }
...
function SID_Container_SR_special_Check($Data, $template, $method){
    $redender = $GLOBALS['redender'];
