...
use \SimplOn\Datas, \SimplOn\Datas\Data, \SimplOn\BaseObject, \SimplOn\Main, \SimplOn\Exception, \SimplOn\Elements\JS, \SimplOn\Elements\CSS;
...
*/
	...
	function allow($user, $method){
		...
		//		require_once Main::$SimplOn_PATH.'/Utilities/Acl/Acl.php';
		//		require_once Main::$SimplOn_PATH.'/Utilities/Acl/Role.php';
		//		require_once Main::$SimplOn_PATH.'/Utilities/Acl/Resource.php';
		//		require_once Main::$SimplOn_PATH.'/Utilities/Acl/Role/GenericRole.php';
		//		require_once Main::$SimplOn_PATH.'/Utilities/Acl/Resource/GenericResource.php';
		//		require_once Main::$SimplOn_PATH.'/Utilities/Acl/Role/Registry.php';
		//
		//
		//		use Zend\Acl;
		//
